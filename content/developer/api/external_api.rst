...
.. tabs::
   ...
   .. group-tab:: Python XML-RPC
      ...
      .. literalinclude:: {ODOO_RELPATH}/odoo/addons/rpc2/tests/test_rpc2_doc.py
         :language: python
         :dedent: 8
   ...
   .. group-tab:: Ruby
      ...
      .. literalinclude:: {ODOO_RELPATH}/odoo/addons/rpc2/tests/test_rpc2_doc.rb
         :language: ruby
   ...
   .. group-tab:: PHP
      ...
      .. literalinclude:: {ODOO_RELPATH}/odoo/addons/rpc2/tests/test_rpc2_doc.php
         :language: php
         :start-after: <a id=common>
         :end-before: </a>
   ...
   .. group-tab:: Java
      ...
      .. literalinclude:: {ODOO_RELPATH}/odoo/addons/rpc2/tests/test_rpc2_doc.java
         :language: java
         :dedent: 8
         :start-after: <a id=common>
         :end-before: </a>
   ...
   .. group-tab:: cURL
      ...
      .. literalinclude:: {ODOO_RELPATH}/odoo/addons/rpc2/tests/test_rpc2_doc.sh
         :language: bash
         :start-after: <a id=common>
         :end-before: </a>

Once the connection is established, you can connect again this time providing a database and a
user/password authentication pair. The result should be the same as above.
...
.. literalinclude:: {ODOO_RELPATH}/odoo/addons/rpc2/tests/doc_result.json
   :language: json
   :start-after: <a id=models>
   :end-before: </a>
...
.. _Apache-xmlrpc-nil: https://github.com/odoo/odoo/blob/master/odoo/addons/rpc2/tests/test_rpc2_doc.java#L14-L29
